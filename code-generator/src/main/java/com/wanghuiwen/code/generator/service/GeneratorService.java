...
import com.wanghuiwen.code.generator.config.ProjectConstant;
...
public class GeneratorService {
    ...
    public void genModelAndMapper(String tableName, String modelName, boolean isMapper, String modulePath, String modelPackage) {
        ...
        p2.setConfigurationType("com.wanghuiwen.common.mybatis.NameSpace");
        ...
        javaModelGeneratorConfiguration.setTargetPackage(ProjectConstant.BASE_PACKAGE + modelPackage + ProjectConstant.MODEL_PACKAGE);
        context.setJavaModelGeneratorConfiguration(javaModelGeneratorConfiguration);

        SqlMapGeneratorConfiguration sqlMapGeneratorConfiguration = new SqlMapGeneratorConfiguration();
        sqlMapGeneratorConfiguration.setTargetProject(modulePath + JAVA_PATH);
        sqlMapGeneratorConfiguration.setTargetPackage(ProjectConstant.BASE_PACKAGE + modelPackage + ProjectConstant.MAPPER_PACKAGE + ".mapper");
        context.setSqlMapGeneratorConfiguration(sqlMapGeneratorConfiguration);


        JavaClientGeneratorConfiguration javaClientGeneratorConfiguration = new JavaClientGeneratorConfiguration();
        javaClientGeneratorConfiguration.setTargetProject(modulePath + JAVA_PATH);
        javaClientGeneratorConfiguration.setTargetPackage(ProjectConstant.BASE_PACKAGE + modelPackage + ProjectConstant.MAPPER_PACKAGE);
    ...
    public void genService(String tableName, String modelName, String modulePath,String modelPackage) {
        try {
            ...
            File file = new File(modulePath + JAVA_PATH + packageConvertPath(ProjectConstant.BASE_PACKAGE + modelPackage+ ProjectConstant.SERVICE_PACKAGE) + modelNameUpperCamel + "Service.java");
            ...
            File file1 = new File(modulePath + JAVA_PATH + packageConvertPath(ProjectConstant.BASE_PACKAGE + modelPackage+ ProjectConstant.SERVICE_IMPL_PACKAGE) + modelNameUpperCamel + "ServiceImpl.java");
