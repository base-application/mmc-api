...
import com.wanghuiwen.user.service.NotificationGradeService;
...
@Service
@Transactional
public class NotificationGradeServiceImpl extends AbstractService<NotificationGrade> implements NotificationGradeService {
    @Resource
